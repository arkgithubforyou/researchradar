  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "SQLITE_DB_PATH", value = "/app/data/researchradar.db" },
        { name = "CHROMA_DB_PATH", value = "/app/data/chroma_db" },
      ]
